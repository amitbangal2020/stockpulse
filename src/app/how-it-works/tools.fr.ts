...
export const TOOL_BODY_FR: Record<string, ToolBodyFr> = {
  generator: {
    ...
    steps: [
      { title: "Ajouter une clé API", detail: "Cliquez sur « Add API Key », choisissez un fournisseur (OpenAI, Gemini, Claude, Grok, Mistral, OpenRouter) et collez votre clé. Ajoutez-en plusieurs — elles tournent automatiquement. Le bouton « Validate All APIs » les vérifie toutes en un clic, ou importez une liste en masse." },
      ...
      { title: "Régler les paramètres", detail: "Définissez les plages de longueur titre/mots-clés/description, la langue de sortie, le ton, le style de prompt, le préfixe et le suffixe de titre, les mots-clés personnalisés, les mots interdits et la concurrence de génération parallèle. « Save Settings » enregistre votre configuration et « Load Settings » la restaure plus tard." },
