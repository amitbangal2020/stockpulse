...
export const TOOL_BODY_FR: Record<string, ToolBodyFr> = {
  generator: {
    ...
    steps: [
      { title: "Ajouter une clé API", detail: "Cliquez sur « Add API Key », choisissez un fournisseur (OpenAI, Gemini, Claude, Grok, Mistral, OpenRouter) et collez votre clé. Ajoutez-en plusieurs — elles tournent automatiquement. Validez-les en un clic ou importez une liste en masse." },
