...
export const TOOL_BODY_DE: Record<string, ToolBodyDe> = {
  generator: {
    ...
    steps: [
      { title: "API-Key hinzufügen", detail: "Klicken Sie auf „Add API Key“, wählen Sie einen Anbieter (OpenAI, Gemini, Claude, Grok, Mistral, OpenRouter) und fügen Sie Ihren Key ein. Mehrere Keys rotieren automatisch. Mit „Validate All APIs“ alle Keys auf einmal prüfen oder eine Liste massenweise importieren. Mit „Save Settings“ speichern Sie Ihr Setup, mit „Load Settings“ laden Sie es später wieder." },
