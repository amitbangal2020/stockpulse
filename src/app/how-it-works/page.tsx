...
const TOOLS: ToolInfo[] = [
  // ─── Main Tools ───
  {
    ...
    tips: ["Use Transparent toggle for PNG/EPS files", "Enable Parallel Generation for faster batch processing", "Try different Prompt Styles for variety"],
    output: "Platform-specific CSV files with title, description, keywords, category",
  },
  {
    id: "tracker",
    name: "Adobe Tracker",
    ...
    category: "Main",
    steps: [
      { title: "Search Assets", detail: "Type a keyword in the search bar. Results show thumbnails with titles, downloads, views, and contributor info." },
      { title: "Filter Results", detail: "Use AI filter (AI Only / Exclude AI / Include AI). Filter by media type, category, and premium level." },
      { title: "View Stats", detail: "Check the summary bar: Total Assets, AI Generated count, Top Performers. Time filter: All Time / Month / Week / Day." },
      { title: "Analyze Trends", detail: "View trending niches, top contributors, and category breakdown. Growth percentages and opportunity scores." },
      { title: "Track Portfolio", detail: "Switch to Watchlist tab to track your own assets. Monitor downloads and performance over time." },
    ],
    tips: ["AI filter helps you understand AI vs handmade market", "Check weekly trends for fresh niches", "Track top competitors for inspiration"],
    output: "Search results, trend data, competitor insights, portfolio tracking",
  },
  {
    id: "svg-video",
    name: "SVG to Video",
