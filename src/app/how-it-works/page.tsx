...
const TOOLS: ToolInfo[] = [
  ...
  },
  {
    ...
    category: "Main",
    steps: [
      { title: "Search by Asset ID", detail: "Enter any Adobe Stock Asset ID (e.g., 212340954) to see the exact download count for that specific asset. Perfect for tracking your own uploads or analyzing competitors." },
      ...
      { title: "Search by Keyword", detail: "Type any keyword to discover related assets. Results show thumbnails with titles, downloads, and contributor info." },
      ...
      { title: "View Performance Stats", detail: "Check the summary bar: Total Results, Total Downloads, Average Downloads, Top Performer. Each asset shows download count + performance bar." },
    ...
    output: "Download counts, portfolio analysis, competitor insights, CSV export",
  },
  {
    id: "svg-video",
    name: "SVG to Video",
